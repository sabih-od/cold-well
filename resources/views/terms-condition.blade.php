    ...
    <section class="terms">
        <div class="container">
            <div class="row align-items-center" id="strategic">
                <div class="col-md-12">
                    <h4>Welcome to The Tax Essentials!</h4>
                    <p>These terms and conditions outline the rules and regulations for the use of The
                        Tax Essentials' Website, located at thetaxessentials.com.</p><br>
                    <p>By accessing this website, we assume you accept these terms and conditions. Do
                        not continue to use The Tax Essentials if you do not agree to take all of the terms and
                        conditions stated on this page.</p><br>
                    <p>The following terminology applies to these Terms and Conditions, Privacy
                        ...
                        you, the person who logs on to this website and is compliant to the Company’s terms and
                        ...
                        the Client’s needs in respect of the provision of the Company’s stated services, in
                        ...
                        are taken as interchangeable and, therefore, as referring to the same.</p><br>
                    <h4>Cookies</h4>
                    <p>We employ the use of cookies. By accessing The Tax Essentials, you agree to use
                        cookies in agreement with The Tax Essentials' Privacy Policy.</p><br>
                    <p>Most interactive websites use cookies to let us retrieve the user’s details for
                        each visit. Cookies are used by our website to enable the functionality of certain areas to
                        make it easier for people visiting our website. Some of our affiliate/advertising partners
                        may also use cookies.</p><br>
                    <h4>License</h4>
                    <p>Unless otherwise stated, The Tax Essentials and/or its licensors own the
                        intellectual property rights for all material on The Tax Essentials. All intellectual
                        property rights are reserved. You may access this from The Tax Essentials for your own
                        personal use, subject to restrictions set in these terms and conditions.</p><br>
                    <p>You must not:</p><br>
                    <ul>
                        <li>Republish material from The Tax Essentials</li>
                        <li>Sell, rent, or sub-license material from The Tax Essentials</li>
                        <li>Reproduce, duplicate or copy material from The Tax Essentials</li>
                        <li>Redistribute content from The Tax Essentials</li>
                    </ul>
                    <p>Parts of this website offer an opportunity for users to post and exchange
                        opinions and information in certain areas of the website. The Tax Essentials does not
                        filter, edit, publish or review Comments prior to their presence on the website. Comments do
                        not reflect the views and opinions of The Tax Essentials, its agents, and/or affiliates.
                        Comments reflect the views and opinions of the person who posts their views and opinions. To
                        the extent permitted by applicable laws, The Tax Essentials shall not be liable for the
                        Comments or for any liability, damages, or expenses caused and/or suffered as a result of
                        any use of and/or posting of and/or appearance of the Comments on this website.</p><br>
                    <p>The Tax Essentials reserves the right to monitor all Comments and to remove any
                    ...
                    <p>You hereby grant The Tax Essentials a non-exclusive license to use, reproduce,
                        edit and authorize others to use, reproduce and edit any of your Comments in any and all
                        forms, formats, or media.</p><br>
                    <h4>Hyperlinking to our Content</h4>
                    <p>following organizations may link to our Website without prior written approval:</p><br>
                    <ul>
                    ...
                    <br>
                    <ul>
                        <li>known consumer and/or business information sources;</li>
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        hyperlink compensates the absence of The Tax Essentials, and (d) the link is in the context of
                        general resource information.</p><br>
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our website, you must inform us by sending an e-mail to The Tax Essentials. Please include your
                        name, your organization name, and contact information as well as the URL of your site, a list of
                    ...
                    <p>No use of The Tax Essentials' logo or other artwork will be allowed for linking absent a
                        trademark license agreement.</p><br>
                    <h4>iFrames</h4>
                    <p>Without prior approval and written permission, you may not create frames around our Webpages that
                        alter in any way the visual presentation or appearance of our Website.</p><br>
                    ...
                    <p>Reservation of Rights</p><br>
                    <p>We reserve the right to request that you remove all links or any particular link to our Website.
                        You approve of immediately removing all links to our Website upon request. We also reserve the
                    ...
                    <p>We do not ensure that the information on this website is correct; we do not warrant its
                        ...
                        the material on the website is kept up to date.</p><br>
                    <h4>Disclaimer</h4>
