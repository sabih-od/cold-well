        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box pd-20 height-100-p mb-30">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="h4 text-blue mb-4">Add Lesson</h4>
                        </div>
                        <div class="col-md-6 text-right">
                            <h4 class="h4 text-blue mb-4">
                                <a href="{{ route('add.lesson') }}" class="btn btn-primary btn-sm scroll-click collapsed">Add</a>
                            </h4>
                        </div>
                    </div>
