        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('index.lesson') }}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('index.lesson') }}">Add
                                Lesson</a></li>
...
{{--                    </div>--}}
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="text" name="add_lesson_title" value="{{ $lesson->lesson_name }}" placeholder="">
                        </div>
                    </div>
{{--                    <div class="form-group row">--}}
