...
@section('content') <section class="pagetitle">
    <div class="container">
        <h1>About us</h1>
    </div>
</section>
...
<section class="about-section">
    <div class="container">
        <div class="col-md-10 mx-auto row flex-row-reverse">
...
<!-- Showcase Section -->
<section class="showcase-section text-center aboutpage">
    <div class="container">
        <div class="col-md-5 mx-auto">
            <h2 class="heading mb-4 text-white">Searching for the Best Places</h2>
            <p class="text-white mb-5 col-md-7 p-0 mx-auto">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
    </div>
</section>
<!-- ! Showcase Section -->
...
<section class="about-section">
    <div class="container">
        <div class="col-md-10 mx-auto row">
            <div class="col-md-6 my-auto pr-5">
                <h2 class="heading mb-4">TITLE GOES HERE</h2>
            ...
            <div class="col-md-6">
                <figure>
                    <img src="images/aboutimg3.jpg" class="img-fluid" alt="">
                </figure>
            </div>
        </div>
    </div>
