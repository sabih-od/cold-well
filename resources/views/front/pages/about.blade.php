...
@section('content')
{{--@dd($about->content)--}}
<section class="innerpage" style="background: url({{ !empty($about->getMedia('about_us_image')->first())
                        ? $about->getMedia('about_us_image')->first()->getUrl()
                        : 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Image_not_available.png/640px-Image_not_available.png' }})">
        <h2 class="slideOne">{{$about->content['about_title']}}</h2>
    </section>
    ...
    <section class="aboutSection">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h2 class="heading mt-4 slideTwo" >{{$about->content['mission_section_title']}}</h2>
                    <p  class="slideTwo">{{$about->content['mission_section_heading']}}</p>
                    <p class="para" data-aos="fade-right">{{$about->content['mission_description']}}</p>
...
{{--                        me being open and willing with pen and paper ready.</p>--}}
            ...
            <div class="row">
                ...
                <div class="col-lg-6"  data-aos="fade-left">
                    <p class="para mt-5 pt-3">{{$about->content['mission_section_description']}}</p>
            ...
            <div class="row">
                <div class="col-12" >
                    <p class="para"  data-aos="fade-right">
                        {{$about->content['mission_section_description']}}
{{--                        I got my first pair of glasses when I was 13 months old. I had such severe vision--}}
...
{{--                        and that we have a long friendship ahead of us.--}}
                    </p>
                </div>
            </div>
        </div>
