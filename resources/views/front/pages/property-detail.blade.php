            ...
            <div class="col-md-10 mx-auto">
                ...
                <div class="row title">
                    <div class="col-md-7">
                        ...
                        <a class="" href="#"><i class="fas fa-map-marker-alt"></i> {{ $property->property_address ?? '' }}</a>
                    </div>
                    <div class="col-md-5">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card card-main">
                            <img src="{{isset($property->property_image) ? asset('images/properties/'.$property->property_image) : asset('images/single-property-01.jpg')}}" alt="">
                            <div class="options">
                    ...
                    <div class="col-md-4 p-0">
                        <div class="smallGallery">
                            <a href="images/single-property-01.jpg" class="smallthumb" data-fancybox="">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row align-items-center">
                                    ...
                                    <p class="mb-0">5905 Wilshire Blvd, Los Angeles</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row align-items-center">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card searchcard">
                                                ...
                                                <div class="card-footer">
                                                    <a href="#" class="h5 m-0">475 Washington Ave, Kingston</a>
                                                    <a href="#" class="p">Friendly Family Houses</a>
                ...
                <div class="col-md-4">
                    <div id="simple" class="sidebarTop">
                        <div class="sidebar">
                            ...
                            <div>
                                <a href="mailto:b.gordon@homeid.com">b.gordon@homeid.com</a>
                            </div>
                            <div>
