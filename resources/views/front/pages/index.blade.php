        ...
        <div class="slider_content">
            <div class="container">
                <div class="col-md-8 mx-auto">
                    ...
                    <p>Team up with a trusted and knowledgeable neighborhood partner to make your real estate dreams come true.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="showcase-section text-center">
        <div class="container">
            <div class="col-md-10 mx-auto">
                ...
                <p class="text-white mb-5">As an agent who's an expert in this local area, I bring a wealth of knowledge and expertise about buying and selling real estate here. It's not the same everywhere, so you need someone you can trust for up-to-date information. I am eager to serve you. Here are some of the things I can do for you</p>
                <div class="row">
                    <div class="col-md-3">
                        <a href="#" class="card">
                            <img src="images/1.png" alt="">
                            <h5>Apartment</h5>
                            <button class="btn btntheme"><span>3</span>Listed Properties <i class="fa-solid fa-angle-right"></i></button>
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="#" class="card">
    ...
    <section class="service-section">
        <div class="container">
            <div class="col-md-11 mx-auto">
                ...
                <p class="text-center mb-5">As an agent who's an expert in this local area, I bring a wealth of knowledge and expertise about buying and selling real estate here. It's not the same everywhere, so you need someone you can trust for up-to-date information. I am eager to serve you. Here are some of the things I can do for you:</p>
            </div>
            <div class="row">
                <div class="col-md-3">
                    <div class="card">
                ...
                <div class="col-md-3">
                    <div class="card">
                        ...
                        <div>
                            ...
                            <p>Oftentimes buyers don't visualize living in your home the way you do. I can make your home attractive to its ideal audience</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
