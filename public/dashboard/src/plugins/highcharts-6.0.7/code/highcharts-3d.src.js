...
(function(factory) {
    ...
    (function(H) {
        ...
        var extendedOptions = {
            ...
            chart: {
                ...
                options3d: {
                    ...
                    /**
                     * Defines the distance the viewer is standing in pages of the chart,
                    ...
                    frame: {
                        ...
                        /**
                         * The pages of the frame around a 3D chart.
                         *
                         * @extends {chart.options3d.frame.bottom}
                         */
                        front: {}
        ...
        wrap(Chart.prototype, 'drawChartBox', function(proceed) {
            if (this.is3d()) {
                ...
                this.frameShapes.front[verb]({
                    'class': 'highcharts-3d-frame highcharts-3d-frame-pages',
        ...
        Chart.prototype.get3dFrame = function() {
            ...
            // docs @TODO: Add all frame options (left, right, top, bottom, pages, back) to
            // apioptions JSDoc once the new system is up.
            var ret = {
                // FIXME: Previously, left/right, top/bottom and pages/back pairs shared
                // size and color.
