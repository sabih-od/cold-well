...
var logoSlider = new Swiper('.featureproduct', {
  loop: true,
  autoplay: true,
  slidesPerView: 4,
  spaceBetween: 10,
...
var industrySlider = new Swiper('.propertyproduct', {
  loop: true,
  slidesPerView: 5,
  spaceBetween: 20,
  // If we need pagination
...
var checkoutSlider = new Swiper('.checkoutSlider', {
  loop: true,
  slidesPerView: 1,
  spaceBetween: 0,
  // If we need pagination
...
var forsalSlider = new Swiper('.forsalSlider', {
  loop: true,
  slidesPerView: 1,
  spaceBetween: 20,
  // If we need pagination
...
// Dropdown Stop to close click inside the menu

$(document).on('click', '.searchProperty .dropdown-menu', function (e) {
  e.stopPropagation()
})
...
$(function() {
  var top = $('#simple').offset().top - parseFloat($('#simple').css('marginTop').replace(/auto/, 0));
  var footTop = $('#footer').offset().top - parseFloat($('#footer').css('marginTop').replace(/auto/, 0));

  var maxY = footTop - $('#simple').outerHeight();

  $(window).scroll(function(evt) {
    var y = $(this).scrollTop();
    if (y > top) {
      if (y < maxY) {
        $('#simple').addClass('sticky').removeAttr('style');
      } 
      // else {
      //   $('#simple').removeClass('sticky').css({
      //     position: 'absolute',
      //     top: (maxY - top) + 'px'
      //   });
      // }
